...
//const canvasFileNode = `{"type": "file", "file":"$file$", "id":"$id$", "x":$x$, "y":$y$, "width":500, "height":500}`
//const canvasTextNode = `{"type": "text", "text":"$text$", "id":"$id$", "x":$x$, "y":$y$, "width":500, "height":500}`
